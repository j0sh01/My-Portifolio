  ...
  return (
    <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
      <div className="flex flex-col md:flex-row justify-between items-center">
        {/* Left Section: Text Content */}
        <div className="flex max-w-[980px] flex-col items-start gap-2 mb-6 md:mb-0 md:mr-6">
          <h1 className="text-3xl font-extrabold leading-tight tracking-tighter md:text-4xl">
            Hi, I&apos;m Joshua Joseph Michael<br className="hidden sm:inline" />
            Frappe/ERPNext Expert & Full-Stack Developer
          </h1>
        ...
        {/* Right Section: Image */}
        <div className="flex-shrink-0">
          <Image src={jmichael} alt="Joshua Joseph Michael" width={250} height={250} className="w-full h-auto max-w-xs md:max-w-full"/>
        </div>
      </div>
    </section>
  );
